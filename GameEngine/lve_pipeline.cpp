...
namespace lve {
	...
	std::vector<char> LvePipeline::readFile(const std::string& filepath)
	{
		...
		if (!file.is_open()) {
			throw std::runtime_error("failed to openm file: " + filepath);
		}
	...
	{
		assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "Cannot create graphics pipeline:: no pieplineLayout provided in configInfo");
